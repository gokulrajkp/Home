      ...
      <ScrollView>
          ...
          <View style={styles.overlay}>
            <View style={styles.top_nav}>
              ...
              <View style={styles.right_side_notification}>
                <Text
                  style={{ color: "#cfe0e5", fontWeight: "bold", fontSize: 16 }}
                >
                  Sell your home
                </Text>
                <MaterialCommIcon
            ...
            <View
              style={{ flex: 1, justifyContent: "center", paddingLeft: 30 }}
            >
              <Text
                style={{ color: "#fcfdfe", fontWeight: "bold", fontSize: 24 }}
              >
                HOME
              </Text>
              <Text style={{ color: "#aecbd3", fontSize: 18 }}>
                By Champion Lender
              </Text>
            </View>
          </View>
          ...
          <View style={{ flexDirection: "row", marginBottom: 10 }}>
            <View style={styles.mainCard}>
              ...
              <Text style={{ color: "#e0e0e0" }}>
                Let's find homes matching your {"\n"} bought and requirements
              </Text>
            </View>
            <View style={styles.homeStash_card}>
              ...
              <Text style={{ color: "#787878", marginTop: 4 }}>
        ...
        <ScrollView horizontal={true} showsHorizontalScrollIndicator={false}>
          <View style={styles.course_card}>
            <Image
              source={require("../assests/sell_home.jpg")}
        ...
        >
          ...
          <View style={{ marginLeft: 15, marginRight: 15 }}>
            <Text
              style={{ color: "#3d94a3", fontSize: 16, fontWeight: "bold" }}
            >
              Live Demo: Home Buying Sources
            </Text>
            <Text style={styles.webinar_text}>
              Join us any day for a live demo of Home{"\n"}Buying Source
            </Text>
            <Text style={[styles.webinar_text, { marginTop: 4 }]}>
